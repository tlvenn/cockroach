...
func (e *Executor) execStmtInOpenTxn(
	...
	case *parser.RollbackToSavepoint:
		...
		// a still-virgin transaction. Virgin means no commands have yet
		// been sent on the transaction, which is reset to true in the event
		// that the transaction is restarted due to a retryable error.
